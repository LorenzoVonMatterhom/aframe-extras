/*
my-look-controls sostituisce i look-controls e consente all'utente di muovere la telecamera anche rispetto all'asse x sui dispositivi touchscreen
*/
...
AFRAME.registerComponent('my-look-controls', {
  ...
  */
  ...
  onTouchMove: function (evt) {
    ...
    if (this.touchStarted && this.data.touchEnabled && evt.touches.length === 1) {
